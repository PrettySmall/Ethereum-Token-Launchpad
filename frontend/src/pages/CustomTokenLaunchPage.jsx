...
import _0EnterTokenInfo from "../components/CustomTokenLaunch/_0EnterTokenInfo";
        ...
        <div className="w-screen h-screen flex flex-col max-[1800px]:items-start items-center overflow-auto">
            <div className="flex flex-col gap-6 items-center mx-6 my-3">
                ...
                <Card className="mx-auto !w-[1200px] !p-6 flex flex-col gap-6 rounded-3xl border-4 border-card-border">
                    <div className="font-conthrax text-lg mx-auto font-medium">Custom Token Creation</div>
                    ...
                    <div className="flex justify-center items-center font-conthrax">
                        <div className="w-36 flex flex-col items-center">
                            ...
                            <div className="mt-2.5 text-gradient-blue-to-purple">Inter Token Info</div>
                        </div>
                        ...
                        <div className="w-36 flex flex-col items-center">
                            ...
                            <div className={`mt-2.5 ${step > 0 ? "text-gradient-blue-to-purple" : "text-gray-label"}`}>Choose Package</div>
                        </div>
                            ...
                            <Collapsible
                                ...
                                trigger={
                                    <div className="flex font-conthrax justify-between items-center">
                                        ...
                                        <div className="flex gap-6 items-center">
                                            {step > 1 && <span className="text-xxs text-green-light">
...
export default CustomTokenLaunchPage;
