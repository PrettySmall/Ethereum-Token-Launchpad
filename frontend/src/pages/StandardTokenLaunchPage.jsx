...
import _1ChooseYourPackage from "../components/StandardTokenLaunch/_1ChooseYourPackage";
...
const StandardTokenLaunchPage = () => {
    const { currentProject } = useContext(AppContext);
    const [selectedProject, setSelectedProject] = useState(currentProject.paymentId == 0 ? { name: "New Project" } : { ...currentProject });
    ...
    useEffect(() => {
        setSelectedProject(currentProject.paymentId == 0 ? { name: "New Project" } : { ...currentProject });
        // setStep(0);
    }, [currentProject])
        ...
        <div className="w-screen h-screen flex flex-col max-[1800px]:items-start items-center overflow-auto">
            <div className="flex flex-col gap-6 items-center mx-6 my-3">
                ...
                <Card className="mx-auto !w-[1200px] !p-6 flex flex-col gap-6 rounded-3xl border-4 border-card-border">
                    <div className="font-conthrax text-lg mx-auto font-medium">Standard Token Creation</div>
                    <div className="mx-40">Meme Tools Multisender sends tokens to multiple addresses while minimizing costs for the sender. All transaction fees are paid by recipients when sending tokens. Choose a token, input a list of recipients, sign the approval, and pay only for a single transaction.</div>
                    <div className="flex justify-center items-center font-conthrax">
                        <div className="w-36 flex flex-col items-center">
                            ...
                            <div className="mt-2.5 text-gradient-blue-to-purple">Choose Package</div>
                        </div>
                        ...
                        <div className="w-36 flex flex-col items-center">
                            ...
                            <div className={`mt-2.5 ${step > 0 ? "text-gradient-blue-to-purple" : "text-gray-label"}`}>Create Contract</div>
                        </div>
                        ...
                        <div className="w-36 flex flex-col items-center">
                            ...
                            <div className={`mt-2.5 ${step > 1 ? "text-gradient-blue-to-purple" : "text-gray-label"}`}>Add Liquidity</div>
                        </div>
                        <img className="mb-6" src={step > 1 ? "/assets/img/dash-confirmed.png" : "/assets/img/dash-unconfirmed.png"} width={70.5} alt="dash" />
                        <div className="w-36 flex flex-col items-center">
                            <img className="px-4" src={step > 2 ? "/assets/img/progress-confirmed.svg" : "/assets/img/progress-unconfirmed.svg"} width={100} alt="process" />
                            <div className={`mt-2.5 ${step > 2 ? "text-gradient-blue-to-purple" : "text-gray-label"}`}>Bundle</div>
                        </div>
                    </div>
                        ...
                        <div className="wizard-div p-6 flex flex-col">
                                    ...
                                    <div className="flex font-conthrax justify-between items-center">
                                        ...
                                        <div className="flex gap-6 items-center">
                                            {step > 0 && <span className="text-xxs text-green-light">
                                                {selectedProject.paymentId && `${PAYMENT_OPTIONS[selectedProject.paymentId].cash} ETH${PAYMENT_OPTIONS[selectedProject.paymentId].token > 0 ? ` & ${PAYMENT_OPTIONS[selectedProject.paymentId].token}% Supply` : ''}`}
                                            </span>}
                            ...
                            >
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="mx-auto p-6 wizard-content">
                                        <_1ChooseYourPackage
...
export default StandardTokenLaunchPage;
