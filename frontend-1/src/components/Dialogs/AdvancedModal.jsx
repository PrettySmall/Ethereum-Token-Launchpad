...
export default function AdvancedModal(props) {
    ...
    return (
        <div className={`${isOpen ? "flex" : "hidden"} absolute top-0 left-0 w-screen h-screen backdrop-blur-md flex flex-row items-center justify-center z-[999] ${props.className ? props.className : ""}`}>
