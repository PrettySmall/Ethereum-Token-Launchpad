...
import { contractAddress, UNISWAP_V2_ROUTER } from "../../utils/constants";

const LiquidityLockWithdraw = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center gap-6">
            <img className="" src="/assets/img/unicrypt_logo.png" width={200} />
            <div className="w-full flex flex-col gap-3">
                <div className="flex flex-col gap-3 items-center justify-between w-full h-auto">
                    <div className="flex items-center mx-auto text-base font-conthrax font-medium text-white">
                        Liquidity Lock
                    </div>
                    <span className="px-20 text-gray-label">
                        Unicrypt Liquidity Locker allows developers to securely store their Liquidity Pool (LP) tokens in a smart contract. This locks the tokens from a specified start date until an end date, revoking the developer's ability to transfer them. This feature enhances trust and stability, ensuring liquidity remains intact for investors.
                    </span>
                </div>
                <InputWithLabel
                    required={true}
                    label="Enter the Uniswap V2 Address You'd Like to Lock Liquidity For"
                    placeholder="Enter token address"
                    value={lockLpBaseTokenAddress}
                    onChange={(v) => setLockLpBaseTokenAddress(v)}
                />
                <div className="flex gap-3">
                    ...
                    <div className="w-1/2">
                        <div className="">
                            <div className="text-gray-label text-left mb-1">
                                Unlock Time
                                <span className="pl-1 text-white">*</span>
                            </div>
                            <div className="flex">
                        ...
                        <div className="mt-3">
                            <InputWithLabel
                                required={true}
                                label="Withraw Address"
                                placeholder="Enter address"
                                value={withdrawAddress}
                                onChange={(v) => setWithdrawAddress(v)}
                            />
                        </div>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-label text-left">Ensure that the "Owner" Wallet has sufficient funds before proceeding with Adding or Locking Liquidity for the contracts or the transaction may fail. Unicrypt Liquidity Lock Cost is 0.1 ETH.</span>
                </div>
            ...
            <div className="w-full flex flex-col gap-3">
                ...
                <InputWithLabel
                    ...
                    onChange={(v) => setWithdrawBaseTokenAddress(v)}
                />
                <div className="">
                    <div className="text-gray-label text-left">
                        Withdraw Amount
...
export default LiquidityLockWithdraw;
