...
import { isValidAddress, updateBlackList } from "../../utils/methods";
...
export default function BlackList() {
    ...
    const handleUpdateBlackList = async () => {
        ...
        setLoadingPrompt("Updating Black List...");
        setOpenLoading(true);

        const ret = await updateBlackList(signer, template, tokenAddress, walletAddress, isExcluded)
        if (ret) {
            toast.success("Black List Updated!");
        } else {
            toast.warn("Failed to update black list!");
        }
