...
export const ExtendedButton = ({ disabled, className, ...other }) => {
  return (
    <button
      disabled={disabled}
      className={`flex justify-center items-center gap-2 px-[9px] py-1.5 rounded-md border border-solid border-transparent text-white cursor-pointer ${className}`}
      {...other}
    ></button>
  );
};
